...
public class MainActivity extends EaseBaseActivity{
    ...
    private  static  EaseConversationListFragment conversationListFragment;
...
//        for(int i = 1; i <= 10; i++){
        ...
        EaseUser user1 = new EaseUser("zhangxh");
        EaseUser user2 = new EaseUser("baseuitest");
        EaseUser user3 = new EaseUser("caseuitest");
        ...
        contacts.put("zhangxh", user1);
        contacts.put("baseuitest", user2);
        contacts.put("caseuitest", user3);
